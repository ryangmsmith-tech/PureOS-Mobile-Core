package com.pureos.mobilecore.s25.v1749;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subtitle.setText("v17.49 • Samsung S25 Clean Install • ARM64 Native");
        ...
        note.setText(
            ...
            "No native GPU frame, vehicle physics, headset test, or production deployment is claimed."
        );
        note.setTextColor(Color.rgb(190, 199, 215));
        note.setTextSize(14);
    ...
    private void updateNativeStatus(TextView status) {
        if (!nativeLibraryLoaded) {
            status.setText("Native ARM64 library: NOT LOADED\n\nReason: " + nativeLoadError);
